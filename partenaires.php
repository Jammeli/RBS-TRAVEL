...
if(isset($_GET['idsupp'])){
   ...
   $sqldelete=mysql_query("select image from partenaires where id='".$_GET['idsupp']."'");
   $resdelete=mysql_fetch_row($sqldelete);
   unlink($resdelete[0]);

	mysql_query("delete from partenaires where  id='".$_GET['idsupp']."'") or die(mysql_error());
...
<body class="fixed-top">
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="recherche_circuit.php"> partenaires</a>
                           <span class="divider">/</span>
                       </li>
                       <li class="active">
                          Images
 ...
 elseif($upload1=="erreur"){echo '<span class="label label-important">NOTE!</span>
	...
	if(isset($_POST['titre'])) $titre=mysql_real_escape_string($_POST['titre']); else $titre='';
	 ...
	 mysql_query("INSERT INTO `partenaires` (`id`, `titre`, `image`) VALUES (NULL,  '".$titre."', '".$upload1."');");
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        <div class="widget-title">
                            <h4><i class="icon-asterisk"></i> Liste des partenaires</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body form">
                           ...
                           <?php
						   	$sqlall=mysql_query("select * from partenaires ") or die(mysql_error());
	
								while($reall=mysql_fetch_array($sqlall)){?>
                                
                                <img  title="<?php echo $reall['titre'];?>"
                                ...
                                <a id="supp<?php echo $reall['id'];?>"  
                                   ...
                                   onMouseOver="document.getElementById('supp<?php echo $reall['id'];?>').style.display='';"
                                style="position:absolute; margin-left:-25px; display:none; background-color:#FFF; height:20px; width:20px; margin-top:5px; text-align:center; text-decoration:none;" href="javascript: if(confirm('Voulez vous effacer l\'image?')) document .location.href='partenaires.php?idsupp=<?php echo $reall['id'];?>'; " ><i class="icon-remove"   ></i></a>
