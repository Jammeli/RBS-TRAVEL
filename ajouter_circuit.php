...
if(isset($_GET['id_circuit'])){
	...
	if($_GET['id_circuit']=="") header("location: ajouter_hotels.php");
$select=mysql_query("select * from circuit where id='".$_GET['id_circuit']."'");
$resselect=mysql_fetch_array($select);
$id_circuit=$resselect['id'];
$titre=$resselect['libelle'];

// echo "select * from circuit where id='".$_GET['id_circuit']."'";
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     <?php if(empty($_GET['id_circuit'])) echo "Ajouter "; else echo "Modifier d'";?>un Circuit
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                       ...
                       <li class="active">
                           <?php if(empty($_GET['id_circuit'])) echo "Ajouter "; else echo "Modifier ";?>
                       </li>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action='function/enregistrer_circuit.php' onSubmit="return test();">
            <input type="hidden" name="id_circuit" value="<?php echo $id_circuit;?>">
...
<?php echo $localisation;?>
     ...
     <!--debut -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Options d'circuit
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
