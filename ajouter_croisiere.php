...
if(isset($_GET['id_croisiere'])){
	...
	if($_GET['id_croisiere']=="") header("location: ajouter_croisiere.php");
$select=mysql_query("select * from croisiere where id='".$_GET['id_croisiere']."'");
$resselect=mysql_fetch_array($select);
$id_croisiere=$resselect['id'];
$titre=$resselect['libelle'];

// echo "select * from croisiere where id='".$_GET['id_croisiere']."'";
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     <?php if(empty($_GET['id_croisiere'])) echo "Ajouter "; else echo "Modifier d'";?>une Croisi&eacute;re
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                       ...
                       <li>
                           <a href="recherche_croisiere.php">Croisi&eacute;res</a>
                           <span class="divider">/</span>
                       </li>
                       <li class="active">
                           <?php if(empty($_GET['id_croisiere'])) echo "Ajouter "; else echo "Modifier ";?>
                       </li>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action='function/enregistrer_croisiere.php' onSubmit="return test();">
            <input type="hidden" name="id_croisiere" value="<?php echo $id_croisiere;?>">
...
<?php echo $localisation;?>
     ...
     <!--debut -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Options de croisiere
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
