...
if(isset($_GET['idsupp'])){
   ...
   $sqldelete=mysql_query("select image from images where id='".$_GET['idsupp']."'");
   $resdelete=mysql_fetch_row($sqldelete);
   unlink($resdelete[0]);

	mysql_query("delete from images where id_hotel='".$_GET['id_hotel']."' and id='".$_GET['idsupp']."'") or die(mysql_error());
	
			header("location: images_hotels.php?id_hotel=".$_GET['id_hotel']);
...
if(isset($_GET['edit_simple'])){
	mysql_query("update images set type='simple' where  id='".$_GET['edit_simple']."'and id_hotel='".$_GET['id_hotel']."'");
		header("location: images_hotels.php?id_hotel=".$_GET['id_hotel']);
...
<body class="fixed-top">
            ...
            <!-- BEGIN PAGE CONTENT-->
                      ...
                      <form class="form-horizontal" action="#" enctype="multipart/form-data" method="post";>
                                ...
                                <div class="control-group">
                                    <div class="controls"><input type="radio" name="type" value="profil">Profil
                                <input type="radio" name="type" value="chambre">Chambre
 ...
 elseif($upload1=="erreur"){echo '<span class="label label-important">NOTE!</span>
	...
	mysql_query("update images set type='simple' where id_hotel='".$_GET['id_hotel']."' and type='profil'") or die(mysql_error());
	 ...
	 mysql_query("INSERT INTO `images` (`id`, `id_hotel`, `type`, `image`) VALUES (NULL, '".$_GET['id_hotel']."', '".$_POST['type']."', '".$upload1."');");
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                           ...
                           <?php
						   	$sqlall=mysql_query("select * from images where id_hotel='".$_GET['id_hotel']."'") or die(mysql_error());
                                ...
                                <a id="supp<?php echo $reall['id'];?>"  
                                   ...
                                   onMouseOver="document.getElementById('supp<?php echo $reall['id'];?>').style.display='';"
                                style="position:absolute; margin-left:-25px; display:none; background-color:#FFF; height:20px; width:20px; margin-top:5px; text-align:center; text-decoration:none;" href="javascript: if(confirm('Voulez vous effacer l\'image?')) document .location.href='images_hotels.php?id_hotel=<?php echo $_GET['id_hotel'];?>&idsupp=<?php echo $reall['id'];?>'; " ><i class="icon-remove"   ></i></a>
...
<?php if( $reall['id']!="profil") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_hotel=<?php echo $_GET['id_hotel'];?>&edit_profil=<?php echo $reall['id'];?>">Image de profil</a></li> <?php }?>
<?php if( $reall['id']!="chambre") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_hotel=<?php echo $_GET['id_hotel'];?>&edit_chambre=<?php echo $reall['id'];?>">Image de chambre</a></li> <?php }?>
<?php if( $reall['id']!="simple") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_hotel=<?php echo $_GET['id_hotel'];?>&edit_simple=<?php echo $reall['id'];?>">Image Simple</a></li> <?php }?>
