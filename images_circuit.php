...
if(isset($_GET['id_circuit'])){
	...
	if($_GET['id_circuit']=="") header("location: recherche_circuit.php");
...
if(isset($_GET['idsupp'])){
   ...
   $sqldelete=mysql_query("select image from images_circuit where id='".$_GET['idsupp']."'");
   $resdelete=mysql_fetch_row($sqldelete);
   unlink($resdelete[0]);

	mysql_query("delete from images_circuit where id_circuit='".$_GET['id_circuit']."' and id='".$_GET['idsupp']."'") or die(mysql_error());
	
			header("location: images_circuit.php?id_circuit=".$_GET['id_circuit']);

	}

if(isset($_GET['edit_profil'])){
	mysql_query("update images_circuit set type='simple' where id_circuit='".$_GET['id_circuit']."' and type='profil'") or die(mysql_error());

	mysql_query("update images_circuit set type='profil' where  id='".$_GET['edit_profil']."'and id_circuit='".$_GET['id_circuit']."'");
	header("location: images_circuit.php?id_circuit=".$_GET['id_circuit']);
	}

if(isset($_GET['edit_simple'])){
	mysql_query("update images_circuit set type='simple' where  id='".$_GET['edit_simple']."'and id_circuit='".$_GET['id_circuit']."'");
		header("location: images_circuit.php?id_circuit=".$_GET['id_circuit']);
...
<body class="fixed-top">
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="recherche_circuit.php"> Circuits</a>
                           <span class="divider">/</span>
                       </li>
                       <li class="active">
                          Images
 ...
 elseif($upload1=="erreur"){echo '<span class="label label-important">NOTE!</span>
	...
	mysql_query("update images_circuit set type='simple' where id_circuit='".$_GET['id_circuit']."' and type='profil'") or die(mysql_error());
	 ...
	 mysql_query("INSERT INTO `images_circuit` (`id`, `id_circuit`, `type`, `image`) VALUES (NULL, '".$_GET['id_circuit']."', '".$_POST['type']."', '".$upload1."');");
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                           ...
                           <?php
						   	$sqlall=mysql_query("select * from images_circuit where id_circuit='".$_GET['id_circuit']."'") or die(mysql_error());
                                ...
                                <a id="supp<?php echo $reall['id'];?>"  
                                   ...
                                   onMouseOver="document.getElementById('supp<?php echo $reall['id'];?>').style.display='';"
                                style="position:absolute; margin-left:-25px; display:none; background-color:#FFF; height:20px; width:20px; margin-top:5px; text-align:center; text-decoration:none;" href="javascript: if(confirm('Voulez vous effacer l\'image?')) document .location.href='images_circuit.php?id_circuit=<?php echo $_GET['id_circuit'];?>&idsupp=<?php echo $reall['id'];?>'; " ><i class="icon-remove"   ></i></a>
...
<?php if( $reall['id']!="profil") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_circuit=<?php echo $_GET['id_circuit'];?>&edit_profil=<?php echo $reall['id'];?>">Image de profil</a></li> <?php }?>
<?php if( $reall['id']!="simple") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_circuit=<?php echo $_GET['id_circuit'];?>&edit_simple=<?php echo $reall['id'];?>">Image Simple</a></li> <?php }?>
