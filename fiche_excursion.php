...
if(isset($_GET['id_excursion'])){
	...
	if($_GET['id_excursion']=="") header("location: ajouter_excursion.php");
...
<div class="actions">
                               <a href="ajouter_excursion.php?id_excursion=<?php echo $_GET['id_excursion'];?>" class="btn btn-success"><i class="icon-pencil"></i> Modifier</a>
                            </div>                            
...
<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
					 ...
					 <a href="ajouter_excursion.php?id_excursion=<?php echo $_GET['id_excursion'];?>">	<button type="button"  name="ajouter" class="btn">Modifier</button></a>
					</div>
				</div>
