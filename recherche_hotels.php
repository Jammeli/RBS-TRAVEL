   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
            ...
            <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Liste des h&ocirc;tels</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                                
                            </span>
                    </div>
                    <a href="ajouter_hotels.php"><button id="editable-sample_new" class="btn green">
                                             Ajouter un H&ocirc;tel <i class="icon-plus"></i>
                                         </button></a>
       ...
       <thead>
                                    ...
                                    <tbody>
                                     <?php
                 $result = mysql_query("SELECT * FROM `hotel`    ORDER BY `id_hotel` DESC;") or die(mysql_error());
