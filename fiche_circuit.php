...
if(isset($_GET['id_circuit'])){
	...
	if($_GET['id_circuit']=="") header("location: ajouter_circuit.php");
...
<div class="actions">
                               <a href="ajouter_circuit.php?id_circuit=<?php echo $_GET['id_circuit'];?>" class="btn btn-success"><i class="icon-pencil"></i> Modifier</a>
                            </div>                            
...
<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
					 ...
					 <a href="ajouter_circuit.php?id_circuit=<?php echo $_GET['id_circuit'];?>">	<button type="button"  name="ajouter" class="btn">Modifier</button></a>
					</div>
				</div>
