   ...
   <div id="container" class="row-fluid">
      ...
      <button class="btn"  style="background-color:#F90 ; font-size:16px; font-weight:bold; color:#FFF;width:32px; height:28px;">!</button>En attente
       ...
       <thead>
                                    ...
                                    <tbody>
                                     <?php
                 $result = mysql_query("SELECT * FROM `demande_billetterie`    ORDER BY `id` DESC;") or die(mysql_error());
		 ...
		 ?>                                   
                                            ...
                                            <td><?php echo $resulta['client'];?></td>
                                            <td><?php echo $resulta['mode'];?></td>
                                            <td><?php echo $resulta['datedepart'];?> <?php echo $resulta['modealler'];?></td>
                                            <td><?php echo $resulta['dateretour'];?> <?php echo $resulta['moderetour'];?></td>
                                            <td><?php echo $resulta['adulte'];?></td>
                                            <td><?php echo $resulta['enfant'];?></td>
                                            <td><?php echo $resulta['datedemande'];?></td>
                                            <td><?php echo $resulta['heuredemande'];?></td>
                                            <td><a href="javascript:window.open('fiche_reservation_billetterie.php?id=<?php echo $resulta['id'];?>','Fiche Billetterie Num <?php echo $resulta['id'];?>','menubar=no, scrollbars=no, top=100, left=100, width=800, height=500');" >Fiche</a></td>
                                         <!--    <td><a href="javascript: if(confirm('Supprimer cette r&eacute;servation ?')) document.location.href='supprimer_reservation_billetterie.php?id=<?php echo $resulta['id'];?>'"><button class="btn btn-danger"><i class="icon-trash "></i></button></a></td>-->
