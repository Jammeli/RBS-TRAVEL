...
if(isset($_GET['idsupp'])){
   ...
   $sqldelete=mysql_query("select image from tourisme_medical_g where id='".$_GET['idsupp']."'");
   $resdelete=mysql_fetch_row($sqldelete);
   unlink($resdelete[0]);

	mysql_query("delete from tourisme_medical_g where  id='".$_GET['idsupp']."'") or die(mysql_error());
	
			header("location: tourisme_medical_g.php");

	}

if(isset($_GET['edit_profil'])){
	mysql_query("update tourisme_medical_g set type='simple' where   type='profil'") or die(mysql_error());

	mysql_query("update tourisme_medical_g set type='profil' where  id='".$_GET['edit_profil']."'");
	header("location: tourisme_medical_g.php");
	}

if(isset($_GET['edit_simple'])){
	mysql_query("update tourisme_medical_g set type='simple' where  id='".$_GET['edit_simple']."'");
		header("location: tourisme_medical_g.php");
...
<body class="fixed-top">
 ...
 elseif($upload1=="erreur"){echo '<span class="label label-important">NOTE!</span>
	...
	mysql_query("update tourisme_medical_g set type='simple' where   type='profil'") or die(mysql_error());
	 ...
	 mysql_query("INSERT INTO `tourisme_medical_g` (`id`,  `type`, `image`) VALUES (NULL,  '".$_POST['type']."', '".$upload1."');");
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                           ...
                           <?php
						   	$sqlall=mysql_query("select * from tourisme_medical_g  ") or die(mysql_error());
...
<?php if( $reall['id']!="profil") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?edit_profil=<?php echo $reall['id'];?>">Image de profil</a></li> <?php }?>
<?php if( $reall['id']!="simple") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?edit_simple=<?php echo $reall['id'];?>">Image Simple</a></li> <?php }?>
