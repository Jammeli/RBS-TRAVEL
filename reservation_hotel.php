   ...
   <div id="container" class="row-fluid">
      ...
      <button class="btn"  style="background-color:#F90 ; font-size:16px; font-weight:bold; color:#FFF;width:32px; height:28px;">!</button>En attente
       ...
       <thead>
                                    ...
                                    <tbody>
                                     <?php
                 $result = mysql_query("SELECT * FROM `demmande_hotel`    ORDER BY `id_commande` DESC;") or die(mysql_error());
		 ...
		 ?>                                   
									...
									?></td>	
                                            ...
                                            <td><?php echo $resulta['datedebut'];?> </td>
                                            <td><?php echo $resulta['datefin'];?></td>
                                            <td><?php echo $resulta['datedemmande'];?></td>
                                            <td><?php echo $resulta['heuredemmande'];?></td>
                                            <td><a href="javascript:window.open('fiche_reservation_hotel.php?id=<?php echo $resulta['id_commande'];?>','Fiche R&eacute;servation H&ocirc;tel  Num <?php echo $resulta['id_commande'];?>','menubar=no, scrollbars=no, top=100, left=100, width=800, height=500');" >Fiche</a></td>
                                            <!--    <td><a href="javascript: if(confirm('Supprimer cette r&eacute;servation ?')) document.location.href='supprimer_reservation_hotel.php?id=<?php echo $resulta['id_commande'];?>'"><button class="btn btn-danger"><i class="icon-trash "></i></button></a></td>-->
