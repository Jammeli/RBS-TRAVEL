...
<div class="actions">
                               <a href="ajouter_croisiere.php?id_croisiere=<?php echo $_GET['id_croisiere'];?>" class="btn btn-success"><i class="icon-pencil"></i> Modifier</a>
                            </div>                            
                       ...
                       <span class="tools">
                        ...
                        <div  class="widget-body form">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                         <?php echo html_entity_decode($description_courte);?>
                                    </div>
                                </div>
                        </div>
                    </div>  
     ...
     <!--debut -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Options d'croisiere
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
...
<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
					 ...
					 <a href="ajouter_croisiere.php?id_croisiere=<?php echo $_GET['id_croisiere'];?>">	<button type="button"  name="ajouter" class="btn">Modifier</button></a>
					</div>
				</div>
