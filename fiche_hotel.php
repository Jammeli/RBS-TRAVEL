...
$val2=explode("-",$val1);
foreach($val2 as $value){
	$sql=mysql_query("select nom from supplement_hotel where id='".$value."'");
	$res=mysql_fetch_row($sql);
	if($value!=0) {$supplement_hotel.='<option  value="'.$value.'" >'.$res[0].'</option>';}
     $chaine.="$value ,";
	}
$chaine.=" 0)";
...
$supplement_hotel0="";
$sql1=mysql_query("select * from supplement_hotel where id NOT IN $chaine ") or die(mysql_error());
while($res1=mysql_fetch_array($sql1)){
         $supplement_hotel0.='  <option value="'.$res1['id'].'">'. $res1['nom'].'</option>';
}
...
<div class="actions">
                               <a href="ajouter_hotels.php?id_hotel=<?php echo $_GET['id_hotel'];?>" class="btn btn-success"><i class="icon-pencil"></i> Modifier</a>
                            </div>                            
          ...
          <input type="text" disabled  class="span6 " name="code" id="code" value="<?php echo $region;?>" />                              
                                    </select>
                                </div>
                            </div> 
                           <div class="control-group">
                                <label class="control-label">Nombre d'&eacute;toiles</label>
                                <div class="controls">
<input type="text" disabled  class="span6 " name="code" id="code" value="<?php echo $etoile;?>" />
                                </div>
                            </div>  
                           <div class="control-group">
                                <label class="control-label">Nom de l'H&ocirc;tel</label>
                                <div class="controls">
                                    <input type="text" disabled  value="<?php echo $nom;?>" class="span6 " name="hotel" id="hotel" />
                                </div>
                            </div>
                            <div class="control-group">
         ...
         <!--fin -->
          ...
          <!--debut  types      -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Types des chambres
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
         ...
         <!--fin -->
          ...
          <!--debut  arrangement      -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Arrangements
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
...
<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
					 ...
					 <a href="ajouter_hotels.php?id_hotel=<?php echo $_GET['id_hotel'];?>">	<button type="button"  name="ajouter" class="btn">Modifier</button></a>
					</div>
				</div>
