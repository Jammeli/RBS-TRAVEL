...
$datedefin=$datedefin2[2]."-".$datedefin2[1]."-".$datedefin2[0];
	...
	$checkout=" id_hotel in( select id_hotel from tarifs where date_fin>= '".$datedefin."' ) ";}else{
				$checkout="";
...
$datedebut=$datedefin2[2]."-".$datedefin2[1]."-".$datedefin2[0];

	$checkin=" id_hotel in( select id_hotel from tarifs where date_depart<= '".$datedebut."' ) ";}else{
				$checkin="";
...
if($checkout!="") array_push($condition, $checkout);
if($checkin!="")  array_push($condition, $checkin);
...
$sql=mysql_query("select * from hotel $result  $orderbymodenom  $limit") or die(mysql_error());
$sqltot=mysql_query("select * from hotel $result  $orderbymodenom ") or die(mysql_error());
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><a href="#" class="link">H&ocirc;tels</a></li>
                                </ol>
                                <div class="clearfix"></div>
                                <h2 class="captions">H&ocirc;tels</h2></div>
                        </div>
                    </div>
                </section>
                <div class="page-main">
