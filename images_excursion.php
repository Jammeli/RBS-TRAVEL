...
if(isset($_GET['id_excursion'])){
	...
	if($_GET['id_excursion']=="") header("location: recherche_excursion.php");
...
if(isset($_GET['idsupp'])){
   ...
   $sqldelete=mysql_query("select image from images_excursion where id='".$_GET['idsupp']."'");
   $resdelete=mysql_fetch_row($sqldelete);
   unlink($resdelete[0]);

	mysql_query("delete from images_excursion where id_excursion='".$_GET['id_excursion']."' and id='".$_GET['idsupp']."'") or die(mysql_error());
	
			header("location: images_excursion.php?id_excursion=".$_GET['id_excursion']);

	}

if(isset($_GET['edit_profil'])){
	mysql_query("update images_excursion set type='simple' where id_excursion='".$_GET['id_excursion']."' and type='profil'") or die(mysql_error());

	mysql_query("update images_excursion set type='profil' where  id='".$_GET['edit_profil']."'and id_excursion='".$_GET['id_excursion']."'");
	header("location: images_excursion.php?id_excursion=".$_GET['id_excursion']);
	}

if(isset($_GET['edit_simple'])){
	mysql_query("update images_excursion set type='simple' where  id='".$_GET['edit_simple']."'and id_excursion='".$_GET['id_excursion']."'");
		header("location: images_excursion.php?id_excursion=".$_GET['id_excursion']);
...
<body class="fixed-top">
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="recherche_excursion.php"> Excursion</a>
                           <span class="divider">/</span>
                       </li>
                       <li class="active">
                          Images
 ...
 elseif($upload1=="erreur"){echo '<span class="label label-important">NOTE!</span>
	...
	mysql_query("update images_excursion set type='simple' where id_excursion='".$_GET['id_excursion']."' and type='profil'") or die(mysql_error());
	 ...
	 mysql_query("INSERT INTO `images_excursion` (`id`, `id_excursion`, `type`, `image`) VALUES (NULL, '".$_GET['id_excursion']."', '".$_POST['type']."', '".$upload1."');");
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                           ...
                           <?php
						   	$sqlall=mysql_query("select * from images_excursion where id_excursion='".$_GET['id_excursion']."'") or die(mysql_error());
                                ...
                                <a id="supp<?php echo $reall['id'];?>"  
                                   ...
                                   onMouseOver="document.getElementById('supp<?php echo $reall['id'];?>').style.display='';"
                                style="position:absolute; margin-left:-25px; display:none; background-color:#FFF; height:20px; width:20px; margin-top:5px; text-align:center; text-decoration:none;" href="javascript: if(confirm('Voulez vous effacer l\'image?')) document .location.href='images_excursion.php?id_excursion=<?php echo $_GET['id_excursion'];?>&idsupp=<?php echo $reall['id'];?>'; " ><i class="icon-remove"   ></i></a>
...
<?php if( $reall['id']!="profil") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_excursion=<?php echo $_GET['id_excursion'];?>&edit_profil=<?php echo $reall['id'];?>">Image de profil</a></li> <?php }?>
<?php if( $reall['id']!="simple") {?><li><a href="<?php echo $_SERVER['PHP_SELF'];?>?id_excursion=<?php echo $_GET['id_excursion'];?>&edit_simple=<?php echo $reall['id'];?>">Image Simple</a></li> <?php }?>
