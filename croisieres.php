...
<head><title>RBS TRAVEL| Croisières</title>
				...
				if(isset($_GET['destination'])){
				 ...
				 $sql_circuis=mysql_query("select * from croisiere where etat='1' $sql1 $sql2 ORDER BY id DESC");?>
    ...
    <div class="wrapper-content"><!-- HEADER-->
        ...
        <div id="wrapper-content"><!-- MAIN CONTENT-->
            <div class="main-content">
                <section class="page-banner cruises-result"  style="background-image:url(assets/images/croisieres.jpg); background-attachment: local;    background-position-y: 28%;">
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    <li><a href="index.html" class="link home">Accueil</a></li>
                                    <li class="active"><a href="#" class="link">Croisières</a></li>
                                </ol>
                                <div class="clearfix"></div>
                                <h2 class="captions">Croisières</h2></div>
                        </div>
                    </div>
	 ...
	 while($resciecuit=mysql_fetch_array($sql_circuis)){?>
                                                <div class="col-sm-4 col-xs-4" >
                                                    <div class="cruises-layout">
                                                        <div class="image-wrapper"><a href="croisiere-<?php echo $resciecuit['id'];?>.html" class="link" style="background-image:url(<?php echo image_profilEX( $resciecuit['id'], 'images_croisiere', 'id_croisiere');?>); background-position:center; background-size:cover; height:250px; width:100%;"></a>

                                                            
                                                        </div>
                                                        <div class="content-wrapper" style="height:350px;">
                                                            <div class="content">
<div style="height: 55px !important;"><a href="croisiere-<?php echo $resciecuit['id'];?>.html" class="title"><?php echo $resciecuit['libelle'];?></a></div>
                                 <div> <p class="offers-content" >(<?php echo nb_vue($resciecuit['id'], 'croisiere');?> visites)</p></div>
...
<a href="croisiere-<?php echo $resciecuit['id'];?>.html" class="btn btn-gray">Détails</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <?php $i++; if($i==3) {$i=0; echo '<hr style="width:100%;">';} }?>
                                                     ...
                                                     <?php if(mysql_num_rows($sql_circuis)==0){?>   <a href="index.html" class="uppercase full-width button btn-large">Pas de Croisières pour le moment</a><?php }?>
                                            </div>
                                        </div>
