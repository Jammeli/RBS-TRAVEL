...
<div class="actions">
                               <a href="ajouter_omra.php?id_omra=<?php echo $_GET['id_omra'];?>" class="btn btn-success"><i class="icon-pencil"></i> Modifier</a>
                            </div>                            
...
<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
					 ...
					 <a href="ajouter_omra.php?id_omra=<?php echo $_GET['id_omra'];?>">	<button type="button"  name="ajouter" class="btn">Modifier</button></a>
					</div>
				</div>
