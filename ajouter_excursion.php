...
if(isset($_GET['id_excursion'])){
	...
	if($_GET['id_excursion']=="") header("location: ajouter_hotels.php");
$select=mysql_query("select * from excursion where id='".$_GET['id_excursion']."'");
$resselect=mysql_fetch_array($select);
$id_excursion=$resselect['id'];
$titre=$resselect['libelle'];

// echo "select * from excursion where id='".$_GET['id_excursion']."'";
   ...
   <div id="container" class="row-fluid">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     <?php if(empty($_GET['id_excursion'])) echo "Ajouter "; else echo "Modifier d'";?>une Excursion
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                       ...
                       <li class="active">
                           <?php if(empty($_GET['id_excursion'])) echo "Ajouter "; else echo "Modifier ";?>
                       </li>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action='function/enregistrer_excursion.php' onSubmit="return test();">
            <input type="hidden" name="id_excursion" value="<?php echo $id_excursion;?>">
...
<?php echo $localisation;?>
     ...
     <!--debut -->
                    <div class="widget orange">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i> Options d'excursion
                            </h4>
                            <span class="tools">
                            <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
...
function test(){
	...
	var decriptl=document.getElementById('decription_longue').value;
